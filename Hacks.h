...
const uintptr_t _GAME_SPEED_OFFSET = 0x414784;
...
const uintptr_t _CONSOLE_UNLOCK_OFFSETS[2] = { 0x25BDFB, 0x28EA41}; // 0x25BAEB
const std::vector<unsigned char> _CONSOLE_UNLOCK_INJECTS[2] = {
    std::vector<unsigned char>{0xE9, 0x41, 0x2C, 0x03, 0x00,},
    std::vector<unsigned char>{0xC7, 0x41, 0x10, 0x01, 0x00, 0x00, 0x00, 0x4C, 0x8B, 0xF2, 0x48, 0x8B, 0xF9, 0xE9, 0xAE, 0xD3, 0xFC, 0xFF}
};
