...
const uintptr_t _GAME_SPEED_OFFSET = 0x416784;
...
const uintptr_t _FASTER_CAMERA_OFFSET = 0x20EAD2;
const std::vector<unsigned char> _FASTER_CAMERA_INJECT{ 0xF3, 0x0F, 0x59, 0x35, 0x76, 0x8C, 0x40, 0x00 };
